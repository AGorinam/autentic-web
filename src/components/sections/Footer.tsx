...
export function Footer() {
  return (
    <footer className="w-full py-20 relative -mt-4">
      <div className="container px-4 max-w-[90%] md:max-w-[88%] mx-auto">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="flex space-x-5 mt-8">
                ...
                <Link href="https://dribbble.com" className="bg-[#1a1d23] hover:bg-[#2a2d33] p-3 rounded-full text-white transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="w-4 h-4">
                    <path d="M8 0C3.58 0 0 3.58 0 8c0 4.42 3.58 8 8 8s8-3.58 8-8c0-4.42-3.58-8-8-8m5.66 3.43a6.95 6.95 0 0 1 1.57 3.93c-.23-.06-1.19-.24-2.25-.24-.34 0-.69.02-1.03.06.04-.1.07-.19.11-.29.16-.39.32-.79.48-1.19 1.02-.46 1.87-.95 2.32-1.26a6.78 6.78 0 0 0-.83-.73 67.31 67.31 0 0 0-.8.58c-.44.33-1.23.83-2.4 1.34-.57.25-1.17.47-1.8.68-.58-1.18-1.2-2.26-1.79-3.25a148.1 148.1 0 0 0 1.92-.68c1.3-.47 2.14-.93 2.65-1.24a6.83 6.83 0 0 0-2.34-.81c-.33.21-1.03.61-2.14 1.03-.78.3-1.57.55-2.26.75.04-.11.08-.21.12-.32.33-.8.7-1.59 1.17-2.36.87-.15 1.77-.23 2.7-.23.66 0 1.3.06 1.92.16.23.28.44.56.65.86zM3.88 7.08c.32.44.87 1.32 1.49 2.61-1.13.34-2.26.54-3.3.62a57.48 57.48 0 0 0-.57.01 6.98 6.98 0 0 1 2.38-3.24M2.28 11.1c.15-.02.82-.13 2.16-.39.72-.14 1.45-.31 2.17-.53.33.65.66 1.31.95 1.97a42.45 42.45 0 0 1-1.92 1.06c-.59.29-1.16.51-1.63.64a7.02 7.02 0 0 1-1.73-2.75m3.12 3.53c.41-.14.91-.34 1.47-.63.69-.34 1.4-.75 2.03-1.17.79 2.07 1.18 3.75 1.27 4.17a6.95 6.95 0 0 1-4.77-2.37M8 14.26c-.05-.35-.3-1.93-1.04-3.84.06-.01.11-.03.17-.05a23.96 23.96 0 0 0 6.1-.83c.16.34.3.69.43 1.05-1.8.65-3.42 1.7-4.72 3.13-.31.34-.58.68-.82 1.01-.04-.15-.08-.31-.12-.47" />
                  </svg>
                </Link>
